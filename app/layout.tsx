...
export const metadata: Metadata = {
	title: 'Melissa Aoko - Software Engineer',
	description:
	...
	authors: [{ name: 'Melissa Aoko' }],
	creator: 'Melissa Aoko',
	openGraph: {
		title: 'Melissa Aoko - Software Engineer Portfolio',
		...
		siteName: 'Melissa Aoko - Portfolio',
		images: [
			{
				url: '/og-image.jpg',
				width: 1200,
				height: 630,
				alt: 'Melissa Aoko - Developer Portfolio',
			},
		],
		locale: 'en_US',
		type: 'website',
